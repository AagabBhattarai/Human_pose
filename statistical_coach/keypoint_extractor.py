...
class PoseExtractor:
    def __init__(self):
        # Hmm, let's think about initialization...
        # We need both pose and drawing solutions from mediapipe
        self.mp_pose = mp.solutions.pose
        self.mp_drawing = mp.solutions.drawing_utils
        
        # Should we use the basic pose solution or the landmarker?
        # The basic pose solution might be simpler and give us normalized coordinates directly
